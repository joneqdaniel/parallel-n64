    ...
    - the focused `469bad6f` sweep at [20260328-469bad6f-previews](/home/auro/code/parallel-n64/artifacts/hires-pack-review/20260328-469bad6f-previews) now narrows that further:
      ...
      - the new full native title package is now runtime-proven and materially stronger than the earlier partial pools:
        ...
        - title-family isolation now narrows the active contributors and removes one redundant pool:
          ...
          - the next low-complexity title gap is now clearer too: `049201f4` and `ce437230` are two one-off sampled `128x32` `1cycle` objects with no pack candidates, and the new title probe [20260328-live-2-fullrow](/home/auro/code/parallel-n64/artifacts/paper-mario-title-block-family-probe/on/20260328-live-2-fullrow) shows they both derive from the same authored-RDRAM `2048x1 fs515` loadblock upload `dfe97266` with a real nonzero row span (`0x404..0xd77`) once the planner captures the full `0x1000` row
