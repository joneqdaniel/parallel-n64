...
- Sampled-object miss telemetry is now split into selector-conflict misses versus unresolved misses.
  ...
  - practical implication: the main file-select native selector gap is no longer the broad `7064585c` family; it has collapsed to one small remaining sampled family, `7872a318` (`4` unresolved misses on the strict fixture)
