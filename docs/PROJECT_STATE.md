...
- Sampled-object miss telemetry is now split into selector-conflict misses versus unresolved misses.
  ...
  - that remaining `7872a318` seam is now formalized as a policy-backed synthetic transport bridge:
    ...
    - new active merged package: [`20260329-selected-plus-title-v24-policy-bridge/package.phrb`](/home/auro/code/parallel-n64/artifacts/hires-pack-review/20260329-selected-plus-title-v24-policy-bridge/package.phrb)
    - strict file select: [`20260329-v24-policy-bridge-runtime`](/home/auro/code/parallel-n64/artifacts/paper-mario-file-select/on/20260329-v24-policy-bridge-runtime) -> hash `3f779e572aea05188467acfbcab3f45f632a42d63cdeecb83536e30ef02c7c43`, exact hits `157`, conflict misses `37`, unresolved misses `0`
    - strict title: [`20260329-v24-policy-bridge-runtime`](/home/auro/code/parallel-n64/artifacts/paper-mario-title-screen/on/20260329-v24-policy-bridge-runtime) -> hash `521539a34c40488bdfe987779a3c53ca1624c3eb985d362f6d1b7934d0064b31`, exact hits `184`, conflict misses `104`, unresolved misses `0`
  - practical implication: the active strict native Paper Mario path is now unresolved-free on both tracked fixtures; the remaining work is selector-conflict shaping and broader generalization, not unknown strict-fixture seams
