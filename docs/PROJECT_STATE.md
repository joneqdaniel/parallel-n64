...
- Sampled-object miss telemetry is now split into selector-conflict misses versus unresolved misses.
  ...
  - that remaining `7872a318` seam is now formalized as a policy-backed synthetic transport bridge:
    ...
    - the surface-policy path is now materially stronger too:
      ...
      - [`tools/hires_surface_transport_policy.json`](/home/auro/code/parallel-n64/tools/hires_surface_transport_policy.json) now promotes `surface-940cea6e` to `dual` selector mode and clones the TLUT-populated `28916d63` copy strip from that same ordered surface
      ...
      - new active merged package: [`20260329-selected-plus-title-v25-surface-policy/package.phrb`](/home/auro/code/parallel-n64/artifacts/hires-pack-review/20260329-selected-plus-title-v25-surface-policy/package.phrb)
      - strict file select: [`20260329-v24-940-289-dual-test-runtime`](/home/auro/code/parallel-n64/artifacts/paper-mario-file-select/on/20260329-v24-940-289-dual-test-runtime) -> hash `3f779e572aea05188467acfbcab3f45f632a42d63cdeecb83536e30ef02c7c43`, exact hits `190`, conflict misses `4`, unresolved misses `0`
      - strict title: [`20260329-v24-940-289-dual-test-runtime`](/home/auro/code/parallel-n64/artifacts/paper-mario-title-screen/on/20260329-v24-940-289-dual-test-runtime) -> hash `521539a34c40488bdfe987779a3c53ca1624c3eb985d362f6d1b7934d0064b31`, exact hits `250`, conflict misses `5`, unresolved misses `0`
      - the policy-built `v25` package is byte-identical to the manual `940+289` dual-surface proof package, so this result is now reproducible from tracked policy/tooling instead of local surface edits
  - practical implication: the active strict native Paper Mario path is now unresolved-free on both tracked fixtures and close to conflict-free too; the remaining work is down to a five-bucket title/file-select tail rather than the old copy-strip selector ceiling
