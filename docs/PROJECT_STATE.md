...
- The current next execution slice is:
  ...
  - the repo-default title-screen, file-select, and `kmr_03 ENTRY_5` authority scenarios now prefer the current enriched full-cache `PHRB` artifact by default instead of the legacy `.hts` path
