...
- The same bridge now also composes with the selected-package builder:
  - active combined package: [`20260329-selected-plus-title-v14-add-289/package.phrb`](/home/auro/code/parallel-n64/artifacts/hires-pack-review/20260329-selected-plus-title-v14-add-289/package.phrb)
  ...
  - self-contained surface-package proof:
    - alias-extension proof: reintroducing [`20260328-title-only-289/bindings.json`](/home/auro/code/parallel-n64/artifacts/hires-pack-review/20260328-title-only-289/bindings.json) on top of the active merged package produces [`20260329-selected-plus-title-v14-add-289/package.phrb`](/home/auro/code/parallel-n64/artifacts/hires-pack-review/20260329-selected-plus-title-v14-add-289/package.phrb), keeps title/file-select hashes unchanged, and raises title sampled-object exact hits from `145` to `178`
    - selector-shape finding: the remaining title misses are no longer best explained as missing payloads. The active `28916d63` and `940cea6e` records each carry `29` transported candidates keyed by upload selectors, while the new title probe shows repeated misses on collapsed canonical selectors (`0574791d28916d63`, `00000000940cea6e`). That points to a flattening limit in the current compiled selector model and strengthens the case for a richer ordered-surface/runtime handoff.
    ...
    - active self-contained selected package: [`20260329-selected-plus-title-v14-add-289/package.phrb`](/home/auro/code/parallel-n64/artifacts/hires-pack-review/20260329-selected-plus-title-v14-add-289/package.phrb)
