...
- The current active combined selected package using this bridge is [`20260329-selected-plus-title-v18-edge-fallback/package.phrb`](/home/auro/code/parallel-n64/artifacts/hires-pack-review/20260329-selected-plus-title-v18-edge-fallback/package.phrb).
  - It merges:
  ...
  - Runtime proofs:
    - title: [`20260329-v18-edge-fallback-probe`](/home/auro/code/parallel-n64/artifacts/paper-mario-title-screen/on/20260329-v18-edge-fallback-probe) -> hash `521539a34c40488bdfe987779a3c53ca1624c3eb985d362f6d1b7934d0064b31`
    - file select: [`20260329-v18-edge-fallback-probe`](/home/auro/code/parallel-n64/artifacts/paper-mario-file-select/on/20260329-v18-edge-fallback-probe) -> hash `c5ac0f7558547aeb197552bbb1a0881c69f6d57ff1f17358d0d1753617d253e0`
- Current meaning of that result:
  ...
  - broader non-menu validation now passed on the first deterministic timeout slices with the active v18 package:
    - `960` world (`kmr_03 entry 5`), [`20260329-title-timeout-960-v18-edge-fallback-fast`](/home/auro/code/parallel-n64/artifacts/paper-mario-probes/on/20260329-title-timeout-960-v18-edge-fallback-fast), matches [`20260329-title-timeout-960-off-baseline`](/home/auro/code/parallel-n64/artifacts/paper-mario-probes/off/20260329-title-timeout-960-off-baseline) exactly (`4bd3929dabff3ffb1b7e03a9c10d8ce50e9b6d0f067825d3a788c48a41b6fc62`)
    - `1200` battle (`kmr_03 entry 0`), [`20260329-title-timeout-1200-v18-edge-fallback-fast`](/home/auro/code/parallel-n64/artifacts/paper-mario-probes/on/20260329-title-timeout-1200-v18-edge-fallback-fast), matches [`20260329-title-timeout-1200-off-baseline`](/home/auro/code/parallel-n64/artifacts/paper-mario-probes/off/20260329-title-timeout-1200-off-baseline) exactly (`0a8b82d3580391c275d4755d57e1c6fab1106c8cd5d1f23626b04088fe4c9a15`)
    - `1500` world (`kmr_06 entry 3`), [`20260329-title-timeout-1500-v18-edge-fallback-fast`](/home/auro/code/parallel-n64/artifacts/paper-mario-probes/on/20260329-title-timeout-1500-v18-edge-fallback-fast), matches [`20260329-title-timeout-1500-off-baseline`](/home/auro/code/parallel-n64/artifacts/paper-mario-probes/off/20260329-title-timeout-1500-off-baseline) exactly (`ef7735c75e16dc83fc19b1a77dc10b7c249631e462de802af2ec86532385258d`)
  - the exact matcher is active on those deeper slices too: each reports `39382` sampled-object exact hits and `0` exact misses, but the final output stays byte-identical to `off`; this is the strongest current evidence that the richer selector model is broad in identity coverage without yet over-asserting visible title-only content into the first non-menu checkpoints
  ...
  - the old flattened-selector ceiling is now resolved on the tracked title path: the v18 edge-fallback package keeps the same strict title and file-select hashes as v14, but title sampled-object exact coverage rises to `184` and exact misses drop to `0`
  - the current selector model is now explicit: fully resolved ordered surfaces compile as `upload-only`, while unresolved surfaces compile as `dual`; `surface-7701ac09` now carries only three ordered fallback selectors, one for each unresolved edge case, instead of a full ordered strip replay
  - practical implication: the runtime is no longer guessing across the whole stripe. Ordered fallback is now constrained to the true unresolved edge holes, which preserves file select and the stable merged title image while still exercising the richer selector path
