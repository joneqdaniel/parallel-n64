...
- Sampled-object miss telemetry is now split into selector-conflict misses versus unresolved misses.
  ...
  - that `7872a318` follow-up is now formalized too:
    ...
    - the surface-policy layer now resolves the dominant remaining copy-strip conflict seam too:
      ...
      - active merged package: [`20260329-selected-plus-title-v25-surface-policy/package.phrb`](/home/auro/code/parallel-n64/artifacts/hires-pack-review/20260329-selected-plus-title-v25-surface-policy/package.phrb)
      - strict file select: [`20260329-v24-940-289-dual-test-runtime`](/home/auro/code/parallel-n64/artifacts/paper-mario-file-select/on/20260329-v24-940-289-dual-test-runtime) -> exact hits `190`, conflict misses `4`, unresolved misses `0`, hash `3f779e572aea05188467acfbcab3f45f632a42d63cdeecb83536e30ef02c7c43`
      - strict title: [`20260329-v24-940-289-dual-test-runtime`](/home/auro/code/parallel-n64/artifacts/paper-mario-title-screen/on/20260329-v24-940-289-dual-test-runtime) -> exact hits `250`, conflict misses `5`, unresolved misses `0`, hash `521539a34c40488bdfe987779a3c53ca1624c3eb985d362f6d1b7934d0064b31`
      - the policy-built `v25` package is byte-identical to the manual `940+289` dual-surface proof package
  - practical implication: the strict native selector model is now both unresolved-free and close to conflict-free; the next phase is tightening the last five residual conflict buckets and then broadening generalization
