...
expected = {
    ...
    "package_manifest_runtime_ready_record_count": 8519,
    ...
    "package_manifest_runtime_ready_compat_record_count": 8491,
    "package_manifest_runtime_deferred_record_count": 364,
    ...
    "promotion_blocker_runtime_state_counts": {"canonical-only": 364},
    "promotion_blocker_reason_counts": {"exact-family-ambiguous": 364},
    "promotion_blocker_reason_unclassified_family_count": 0,
    "unresolved_family_reason_runtime_state_counts": {
        "exact-family-ambiguous": {"canonical-only": 364, "runtime-ready-package": 4}
    },
    "unresolved_family_reason_variant_group_count_counts": {"exact-family-ambiguous": {"2": 255, "3": 52, "4": 60, "5": 1}},
    "unresolved_family_canonical_only_review_group_count": 131,
    "unresolved_family_canonical_only_family_count": 364,
...
if report.get("canonical_family_selection_review_selection_count") != 4:
    raise SystemExit(
...
if report.get("canonical_family_selection_review_family_count") != 4:
    raise SystemExit(
