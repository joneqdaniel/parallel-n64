...
- [`tools/hires_runtime_overlay_review_profile.json`](/home/auro/code/parallel-n64/tools/hires_runtime_overlay_review_profile.json) is the current tracked review-only overlay reduction input for that same full-cache lane. It applies the bounded `fs259` / `fs4` transport selections from [`tools/hires_runtime_overlay_review_transport_policy.json`](/home/auro/code/parallel-n64/tools/hires_runtime_overlay_review_transport_policy.json), and the latest persistent proof at [`artifacts/hts2phrb-review/20260409-pm64-all-families-authority-context-overlay-review-profile/hts2phrb-report.json`](/home/auro/code/parallel-n64/artifacts/hts2phrb-review/20260409-pm64-all-families-authority-context-overlay-review-profile/hts2phrb-report.json) reduces the residue to `19` bindings / `9` unresolved with the top-level split now reading `8` direct overlay cases plus `1` import-linked case and no grouped candidate-set review entries, while still passing the strict full-cache authority wrapper. The paired [`hts2phrb-runtime-overlay-linked-import-review.md`](/home/auro/code/parallel-n64/artifacts/hts2phrb-review/20260409-pm64-all-families-authority-context-overlay-review-profile/hts2phrb-runtime-overlay-linked-import-review.md) now keeps the only remaining non-deferred overlay blocker explicit as the `7064585c` linked-import cluster. It stays explicitly non-default.
