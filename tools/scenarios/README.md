...
- add `--emit-import-index` to [hires_pack_migrate.py](/home/auro/code/parallel-n64/tools/hires_pack_migrate.py) when you want the first imported-index scaffold rather than just the tier report
